...
- `src/trinity_local/` unchanged. <!-- canonical:test_count -->1938<!-- /canonical --> tests stay green (was 1290 at the floor's ratification; the consistency sweep + the Gap A/B/C ship grew the count — see CHANGELOG v1.7.4 sweep section for the delta).
