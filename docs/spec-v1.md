...
### MCP tool surface (<!-- canonical:mcp_tool_count -->9<!-- /canonical --> total: 4 canonical + 3 v1.5 + 1 launch-arc)

The original spec wanted 3 tools (council / query_lens / add_pair). Current ships <!-- canonical:mcp_tool_count -->9<!-- /canonical --> —
