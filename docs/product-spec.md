...
| Module | Key commands |
|--------|-------------|
| `commands/council.py` | `council-start`, `council-launch`, `council-rate`, `council-stop`, `council-share`, `council-iterate` (former `council-html` retired 2026-05-17 with the verifier→synthesis rename) |
