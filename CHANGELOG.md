...
suite was 2300+ — a hardcoded count that rotted silently the moment the suite grew.
Reworded to "the full-suite green gate" (no number to drift). Historical-class docs
(e.g. CUT-CANDIDATES.md) keep their point-in-time numbers — those are snapshots, not
live claims.
...
use `<!-- canonical:test_count -->2447<!-- /canonical -->`. 7 surfaces
