...
green on every commit, and the gate currently runs <!-- canonical:test_count -->1884<!-- /canonical --> tests in ~150s.
...
.venv/bin/python -m pytest -q       # <!-- canonical:test_count -->1884<!-- /canonical --> tests, ~140s; gate must stay green
