...
├── moves/                          # Promoted moves (procedural layer, v2 substrate — #167)
│   ├── <slug>/SKILL.md             #   one move per slug; agentskills.io format + trinity_* frontmatter
│   └── archive/                    #   demoted moves preserved with trinity_demoted_by_tier for debugging
