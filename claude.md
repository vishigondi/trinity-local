...
12. **Test suite: 1372 passing** (1290 baseline at session start → 1372 after the three-tier restructure landed 82 new tests across scripts/, trust/audit, tier-equivalence, fresh-install, and Phase 7 council pre-empts).
...
- `pytest -q` — **1372 passed** + 4 skipped (36 in `test_doc_count_consistency.py` defending launch-credibility claims; 4 skipped are the gated real-Chrome smokes that need a loaded extension to run).
